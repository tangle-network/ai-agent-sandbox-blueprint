...
# Tangle protocol addresses in the anvil fixture the blueprint CLI ships
# (blueprint cli/src/command/dev/up.rs, tnt-core 0.19). The April-2026 pins
# were empty accounts in the current snapshot, so createBlueprint reverted and
# the driver compliance suite never reached vitest (2026-09-09).
TANGLE="0x0165878A594ca255338adfa4d48449f69242Eb8F"
RESTAKING="0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9"
