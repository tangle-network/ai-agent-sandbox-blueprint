...
> **⚠️ Attestation verification is feature-gated and hardware-dependent.**
>
> With `tee-verify`, the runtime verifies TDX and SEV-SNP evidence against their hardware roots and AWS Nitro documents against the pinned AWS Nitro Root-G1.
> Without `tee-verify`, the runtime reports `Unverified` and never claims hardware trust.
