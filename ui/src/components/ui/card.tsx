...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn('glass-card rounded-xl text-cloud-elements-textPrimary', className)}
      {...props}
    />
  );
}
...
function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-description" className={cn('text-cloud-elements-textSecondary text-sm', className)} {...props} />;
}
