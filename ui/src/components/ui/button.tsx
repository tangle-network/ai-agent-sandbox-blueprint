...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-display transition-all duration-200 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*="size-"])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-violet-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-cloud-elements-background-depth-1',
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'glass glass-hover text-cloud-elements-textPrimary',
        secondary:
          'bg-cloud-elements-background-depth-3 text-cloud-elements-textSecondary border border-cloud-elements-borderColor hover:bg-cloud-elements-background-depth-4 hover:text-cloud-elements-textPrimary',
        ghost:
