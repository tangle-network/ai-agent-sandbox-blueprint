export function Footer() {
  return (
    <footer className="border-t border-cloud-elements-dividerColor py-5 mt-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 flex items-center justify-between text-xs text-cloud-elements-textTertiary">
        <span className="font-data">Sandbox Cloud · Tangle Network</span>
