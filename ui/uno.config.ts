...
export default defineConfig({
  ...
  // Icons used in dynamic contexts (ternaries, props, cn()) that UnoCSS
  // cannot statically detect.  Regenerate with:
  //   grep -rohP 'i-ph:[a-z][a-z0-9-]*' src/ | sort -u
