  ...
  return (
    <div className="flex items-center gap-1">
      {sorted.map((cat) => (
        <div
          key={cat}
          className={cn(TOOL_CATEGORY_ICONS[cat], 'w-3 h-3 text-neutral-400 dark:text-neutral-500')}
          title={cat}
        />
      ))}
    </div>
          ...
          >
            ...
            {isStreaming && (
              <div className="flex items-center gap-1.5">
                <div className="i-ph:circle-notch w-3 h-3 text-blue-500 dark:text-blue-400 animate-spin" />
